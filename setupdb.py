...
def delete_all():
    dbstring = "drop table tx_outputs;drop table inputs;drop table address_address_correlation;drop table address_person_correlation;drop table addresses;drop table outputs; drop table people; drop table correlations; drop table meta; drop table transactions"
    db.dbexecute(dbstring, False)
